<template>
    <div>
        ...
        <div v-if="gameExists">
            ...
            <GamePane :key="myGameID + '/' + myPlayerID" v-if="connected && inGame" :myGameID="myGameID" :originalPlayerID="myPlayerID" :initialEvents="gameEvents" @GameError="handleCommandError">
            </GamePane>
        </div>
